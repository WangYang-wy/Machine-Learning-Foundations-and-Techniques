...
Occam’s Razor反映到机器学习领域中，指的是在所有可能选择的模型中，我们应该选择能够很好地解释已知数据并且__十分简单__的模型。
...
其实，simple hypothesis h和simple model H是紧密联系的。如果hypothesis的特征个数是 ${l}$ ，那么H中包含的hypothesis个数就是 ${2^{l}}$ ，也就是说，hypothesis特征数目越少，H中hypothesis数目也就越少。
